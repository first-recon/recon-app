...
Collection.prototype.getData = function () {
  if (!this.data) {
    console.log(`Reading from ${fs.documentDirectory + this.path}`);
    return fs.readAsStringAsync(fs.documentDirectory + this.path)
      .then(JSON.parse)
...
Collection.prototype.save = function () {
  ...
  return fs.writeAsStringAsync(fs.documentDirectory + this.path, JSON.stringify(dataToWrite, null, '  '));
};
